...
public class IncidenceEntryRecord extends UpdatableRecordImpl<IncidenceEntryRecord> implements Record11<Integer, Integer, Integer, Integer, Integer, Integer, Integer, Short, Short, Boolean, Integer> {
    ...
    @Override
    public Row11<Integer, Integer, Integer, Integer, Integer, Integer, Integer, Short, Short, Boolean, Integer> valuesRow() {
    ...
    @Override
    public IncidenceEntryRecord values(Integer value1, Integer value2, Integer value3, Integer value4, Integer value5, Integer value6, Integer value7, Short value8, Short value9, Boolean value10, Integer value11) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public IncidenceEntryRecord(Integer id, Integer incidenceDatasetId, Integer year, Integer endpointGroupId, Integer endpointId, Integer raceId, Integer genderId, Short startAge, Short endAge, Boolean prevalence, Integer ethnicityId) {
        super(IncidenceEntry.INCIDENCE_ENTRY);
