...
public class Indexes {
    ...
    public static final Index TASK_COMPLETE_ON_DATE = Internal.createIndex(DSL.name("task_complete_on_date"), TaskComplete.TASK_COMPLETE, new OrderField[] { TaskComplete.TASK_COMPLETE.COMPLETED_DATE }, false);
    ...
    public static final Index TASK_QUEUE_ON_DATE = Internal.createIndex(DSL.name("task_queue_on_date"), TaskQueue.TASK_QUEUE, new OrderField[] { TaskQueue.TASK_QUEUE.SUBMITTED_DATE }, false);
    public static final Index TASK_QUEUE_ON_PRIORITY_SUBMITTED_DATE = Internal.createIndex(DSL.name("task_queue_on_priority_submitted_date"), TaskQueue.TASK_QUEUE, new OrderField[] { TaskQueue.TASK_QUEUE.PRIORITY, TaskQueue.TASK_QUEUE.SUBMITTED_DATE }, false);
